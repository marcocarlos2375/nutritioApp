        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text('Ingredients:',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal,fontFamily: "Poppins")),
              ...
              for (var instruction in recipe.instructions)
                Text('- $instruction', style: TextStyle(fontSize: 16,fontFamily: "Poppins",fontWeight: FontWeight.normal)),
              SizedBox(height: 10),
              Text('Nutrition:',
